...
SELECT course_name,men/(men+women) as ratio 
FROM #gender
...
SELECT departments.DepartmentName AS department_name,
	...
	(COUNT (CASE WHEN (classrooms.degree<60) THEN (classrooms.degree) END))/(COUNT(classrooms.degree)*1.00) AS ratio_of_low_students
FROM departments
INNER JOIN courses ON departments.DepartmentId=courses.DepartmentID
INNER JOIN classrooms ON courses.CourseID=classrooms.CourseId
GROUP BY DepartmentName
