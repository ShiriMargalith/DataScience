...
CREATE TABLE teachers (TeacherId INT, FirstName VARCHAR(50), LastName VARCHAR(50), Gender VARCHAR(1))
CREATE TABLE students (StudentId INT, FirstName VARCHAR(50), LastName VARCHAR(50), Gender VARCHAR(1))
CREATE TABLE courses (CourseId INT, CourseName VARCHAR(50), DepartmentID INT, TeacherId INT)
...
INSERT INTO dbo.classrooms VALUES (1, 123, 62.4204486562428)
...
INSERT INTO dbo.classrooms VALUES (1, 4, 70.9298007287377)
...
INSERT INTO dbo.classrooms VALUES (1, 42, 72.048243179129)
...
INSERT INTO dbo.classrooms VALUES (1, 196, 90.6560327284547)
...
INSERT INTO dbo.classrooms VALUES (2, 164, 83.6171730782503)
...
INSERT INTO dbo.classrooms VALUES (3, 251, 80.3248212818938)
...
INSERT INTO dbo.classrooms VALUES (3, 223, 64.203897834737)
...
INSERT INTO dbo.classrooms VALUES (3, 189, 74.1635279535029)
INSERT INTO dbo.classrooms VALUES (3, 132, 78.7751515175165)
...
INSERT INTO dbo.classrooms VALUES (4, 168, 88.955578077069)
INSERT INTO dbo.classrooms VALUES (4, 222, 69.8417099830021)
INSERT INTO dbo.classrooms VALUES (4, 84, 84.3417101273606)
INSERT INTO dbo.classrooms VALUES (4, 196, 71.5429953669102)
...
INSERT INTO dbo.classrooms VALUES (6, 161, 86.8519401036964)
...
INSERT INTO dbo.classrooms VALUES (7, 226, 70.1521056215719)
INSERT INTO dbo.classrooms VALUES (7, 66, 62.3186157233748)
INSERT INTO dbo.classrooms VALUES (7, 198, 69.7774098546574)
...
INSERT INTO dbo.classrooms VALUES (8, 61, 80.8323601565071)
...
INSERT INTO dbo.classrooms VALUES (9, 75, 73.6487516503669)
...
INSERT INTO dbo.classrooms VALUES (11, 49, 64.6860522608039)
INSERT INTO dbo.classrooms VALUES (11, 131, 75.6106429743482)
INSERT INTO dbo.classrooms VALUES (11, 171, 75.7210741641263)
...
INSERT INTO dbo.classrooms VALUES (11, 18, 84.3809882459043)
...
INSERT INTO dbo.classrooms VALUES (13, 265, 82.6345684193988)
...
INSERT INTO dbo.classrooms VALUES (14, 191, 71.7408451212311)
INSERT INTO dbo.classrooms VALUES (14, 121, 79.3752667707706)
INSERT INTO dbo.classrooms VALUES (14, 112, 74.8991611152405)
...
INSERT INTO dbo.classrooms VALUES (15, 273, 80.5520136588442)
...
INSERT INTO dbo.classrooms VALUES (16, 143, 88.9121496150867)
...
INSERT INTO dbo.classrooms VALUES (16, 10, 82.9706364831201)
...
INSERT INTO dbo.classrooms VALUES (17, 90, 82.0111849816523)
...
INSERT INTO dbo.classrooms VALUES (17, 27, 76.0088787259489)
...
INSERT INTO dbo.classrooms VALUES (18, 17, 68.3241530340106)
...
INSERT INTO dbo.classrooms VALUES (20, 223, 85.5760369263927)
...
INSERT INTO dbo.classrooms VALUES (20, 233, 74.2677603471469)
...
INSERT INTO dbo.classrooms VALUES (21, 64, 82.4214039064704)
INSERT INTO dbo.classrooms VALUES (21, 10, 80.0850314885584)
INSERT INTO dbo.classrooms VALUES (21, 16, 80.1832402653204)
INSERT INTO dbo.classrooms VALUES (21, 21, 90.4927631035379)
INSERT INTO dbo.classrooms VALUES (21, 224, 70.029849054158)
INSERT INTO dbo.classrooms VALUES (21, 203, 85.097384960181)
...
INSERT INTO dbo.classrooms VALUES (22, 222, 74.1679425332593)
...
INSERT INTO dbo.classrooms VALUES (23, 251, 84.5113381994047)
...
INSERT INTO dbo.classrooms VALUES (24, 62, 90.3258042839206)
...
INSERT INTO dbo.classrooms VALUES (24, 44, 81.7594626427016)
...
INSERT INTO dbo.classrooms VALUES (27, 168, 66.3126393870754)
INSERT INTO dbo.classrooms VALUES (27, 224, 80.4365766006031)
...
--2a. How many students in each department?
SELECT departments.DepartmentName AS department_name,
	Count(classrooms.StudentId) AS num_of_students
FROM departments
...
--2b. How many students in each English course and how many students total?
SELECT courses.CourseName AS course_name,
	(SELECT COUNT(*) AS all_English_students
	FROM dbo.courses 
	INNER JOIN dbo.departments ON courses.DepartmentId=departments.DepartmentId
	INNER JOIN dbo.classrooms ON courses.CourseId=classrooms.CourseId
	WHERE departments.DepartmentName = 'English') AS total_num_of_English_students,
COUNT(classrooms.StudentId) AS num_of_students_per_course
FROM dbo.courses
INNER JOIN dbo.departments ON courses.DepartmentId=departments.DepartmentId
INNER JOIN dbo.classrooms ON courses.CourseId=classrooms.CourseId
...
--2c. How many small classes and how many large classes in Science department?
--First option: provide only the total number of small classes and large classes without course name:
--DROP TABLE #class_size
SELECT courses.CourseName AS course_name,
CASE WHEN COUNT (classrooms.studentID)<22 THEN 'Small'
	ELSE 'Large'
	END AS class_size
INTO #class_size
FROM dbo.courses
...
SELECT class_size, COUNT(course_name) AS num_of_classes
FROM #class_size
GROUP BY class_size

--Second option: list all Science courses and define which requires a small class and which requires a large class:
SELECT courses.CourseName AS course_name,
CASE WHEN COUNT (classrooms.studentID)<22 THEN 'Small'
	ELSE 'Large'
	END AS class_size
...
--2d. How many male students vs. female students?
SELECT Gender, Count(StudentId) AS num_of_students
FROM students 
GROUP BY gender

--2e. In which courses are there 70% male studets?
--DROP TABLE #gender
SELECT courses.courseName AS course_name, 
		COUNT (CASE WHEN (students.gender='F') THEN students.studentID END)*1.00 AS women,
		COUNT (CASE WHEN (students.gender='M') THEN students.studentID END)*1.00 AS men
INTO #gender
FROM courses
INNER JOIN classrooms ON courses.CourseId=classrooms.courseId
INNER JOIN students ON classrooms.studentId=students.studentId
GROUP BY courses.courseName

SELECT course_name
FROM #gender
WHERE (women=0 AND men>0) OR (men/(men+women)>=0.7)

--2f. In each department, how many students with grade over 80?
SELECT departments.DepartmentName AS department_name,
	COUNT (CASE WHEN (classrooms.degree>80) THEN (classrooms.degree) END) AS top_students,
	(COUNT (CASE WHEN (classrooms.degree>80) THEN (classrooms.degree) END))/(COUNT(classrooms.degree)*1.0) AS ratio_of_top_students
FROM departments
INNER JOIN courses ON departments.DepartmentId=courses.DepartmentID
INNER JOIN classrooms ON courses.CourseID=classrooms.CourseId
GROUP BY DepartmentName

--2g. In each department, how many students failed (under 60)
SELECT departments.DepartmentName AS department_name,
	COUNT (CASE WHEN (classrooms.degree<60) THEN (classrooms.degree) END) AS low_students,
	(COUNT (CASE WHEN (classrooms.degree<60) THEN (classrooms.degree) END))/(COUNT(classrooms.degree)*1.00) AS ratio
FROM departments
INNER JOIN courses ON departments.DepartmentId=courses.DepartmentID
INNER JOIN classrooms ON courses.CourseID=classrooms.CourseId
GROUP BY DepartmentName

--2h.Order of teachers by studnets' GPA from highest to lowest
SELECT teachers.teacherId,
	MAX(teachers.FirstName) AS first_name,
	MAX(teachers.LastName) AS last_name,
	AVG(classrooms.degree) gpa
FROM teachers
INNER JOIN courses ON teachers.TeacherId=courses.TeacherId
INNER JOIN classrooms ON courses.CourseId=classrooms.CourseId
GROUP BY teachers.TeacherId
ORDER BY gpa DESC

--3a. View for each course including departments, teacher and number of students:
--DROP VIEW course_info_view
CREATE VIEW course_info_view AS
SELECT courses.CourseName AS course_name,
MAX(departments.DepartmentName) AS department_name,
MAX(teachers.FirstName) AS teacher_first_name,
MAX(teachers.LastName) AS teacher_last_name,
COUNT(classrooms.StudentId) AS num_of_students
FROM courses
...
LEFT OUTER JOIN classrooms ON courses.CourseId=classrooms.CourseId
GROUP BY courses.CourseName

--SELECT * FROM course_info_view

--3b. View for each student including number of courses, GPA per department and total GPA
--DROP VIEW student_info_view
CREATE VIEW student_info_view AS
SELECT students.StudentId AS student_ID,
	MAX(students.FirstName) AS student_first_name,
	MAX(students.LastName) AS student_last_name,
	COUNT(classrooms.courseID) as num_of_courses,
	AVG (classrooms.degree) AS total_gpa,
